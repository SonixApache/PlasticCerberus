...
*/
// Place tasks here
[WEST, "MAINTASK", ["Reach the airfield at any cost. This is your primary objective.<br/><br/>And remember, no man left behind.<br/>Your mission will only be complete when all of your active forces makes it home.", "Reach the base", "REACH"], getMarkerPos "ENDZONE", "ASSIGNED", 0, true, "land", true] call BIS_fnc_taskCreate;

[WEST, "OPTIONALTASKS", ["There are some additonal tasks available, if you are willing and able.", "Optional tasks", "OPTIONAL"], objNull, "CREATED", 0, false, "danger", true] call BIS_fnc_taskCreate;
